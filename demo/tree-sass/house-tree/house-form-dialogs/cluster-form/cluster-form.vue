        ...
        coverData: {
          resourcefieldBindingfnList: {
            houseName: (params) => {
              ...
              if (params.type === 'blur') {
                if (params.formData.modelData.clusterShortName === undefined || params.formData.modelData.clusterShortName === '') {
      ...
      autoFormSubmit(formName) {
        this.autoForm.validate(formName).then(
          params => {
            ...
            modelData.houseType = '3';
            modelData.houseTypeEnum = 'CLUSTER';
