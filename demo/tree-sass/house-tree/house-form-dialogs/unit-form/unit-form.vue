        ...
        coverData: {
          resourcefieldBindingfnList: {
            houseName: (params) => {
              ...
              if (params.type === 'blur') {
                if (params.formData.modelData.unitShortName === undefined || params.formData.modelData.unitShortName === '') {
      ...
      autoFormSubmit(formName) {
        this.autoForm.validate(formName).then(
          params => {
            ...
            modelData.houseType = '5';
            modelData.houseTypeEnum = 'UNIT';
